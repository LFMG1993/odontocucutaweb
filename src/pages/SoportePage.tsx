...
export const SoportePage: React.FC = () => {
    ...
    const fallbackTicketId = ticketCreado ? (ticketCreado as any).ticket_id : undefined

    return (
        <div className="min-h-screen bg-slate-50/50 py-10 lg:py-16" ref={heroRef}>
            <SEO
            ...
            <div className="container-main">
                <div className="max-w-4xl mx-auto space-y-6 py-8">
                    ...
                    {catalogosError && (
                        <div
                            className="p-5 rounded-2xl bg-red-50 border border-red-200 text-red-800 text-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 animate-fade-in-entry shadow-sm">
                            <div className="flex items-start gap-3">
                                <AlertCircle className="w-5 h-5 text-red-600 shrink-0 mt-0.5"/>
                                <div>
                                    <h4 className="font-black text-sm text-red-900">No fue posible cargar el
                                        formulario</h4>
                    ...
                    {submitError && (
                        <div
                            className="p-4 rounded-2xl bg-red-50 border border-red-200 text-red-800 text-xs flex items-start gap-3 animate-fade-in-entry shadow-xs">
                            <AlertCircle className="w-5 h-5 text-red-600 shrink-0 mt-0.5"/>
                            <div>
